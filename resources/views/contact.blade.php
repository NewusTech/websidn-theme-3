...
<head>
    ...
    <body>
        ...
        <!-- Contact Start -->
        <div class="container-fluid py-2 bg-light wow bounceInUp text-center" data-wow-delay="0.1s" style="background: var(--bs-primary);">
                ...
                <div class="p-4 bg-light rounded contact-form">
                    <div class="row justify-content-center">
                        <div class="col-12 align-items-center">
                            ...
                            <h4 class="display-6 mb-4">Hubungi Kami</h4>
                            <p class="mb-4 text-dark">Jika ada pertanyaan atau butuh informasi lebih lanjut mengenai layanan kami, jangan ragu menghubungi kami melalui kontak, email, atau telepon. Tim kami siap membantu dan memberikan solusi terbaik. Terima kasih atas kepercayaan Anda!</p>
                        </div>
                    </div>

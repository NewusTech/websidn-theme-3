                    ...
                    <nav class="navbar navbar-light navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse bg-light py-1" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top">
                                ...
                                <a href="/portofolio" class="nav-item nav-link active fs-5"><b>Portofolio</b></a>
        ...
        <div class="container-fluid services py-3">
            <div class="container py-3">
                <div class="mx-auto text-center mb-5" style="max-width: 800px;">
                    ...
                    <h1 class="display-6">Jelajahi Project Terbaru Kami </h1>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 px-4">
                        <div class="card" >
                            ...
                            <div class="card-body text-dark">
                              ...
                              <a href="/document-portofolio" class="btn btn-primary w-100 text-white">See Project</a>
                            </div>
                        </div>
                    </div> 
                    @endforeach
